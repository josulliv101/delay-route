...
var DelayRoute = function (_React$Component) {
  ...
  DelayRoute.prototype.render = function render() {
    ...
    if (transitioning || delay) return [_react2.default.createElement(_reactRouter.Route, _extends({ hidden: true, key: 'transitioningTo' }, this.props, { location: { pathname: validDelayPath || rawDelayPath } })), _react2.default.createElement(_reactRouter.Route, _extends({ key: 'main' }, this.props))];

(function (global, factory) {
	...
	(factory((global.DelayRoute = {}),global.React));
...
var _resolvePathname2 = _interopRequireDefault(index$1);



var _valueEqual2 = _interopRequireDefault(index$3);
...
Router.propTypes = {
  history: index.object.isRequired,
  children: index.node
};
Router.contextTypes = {
  router: index.object
...
MemoryRouter.propTypes = {
  initialEntries: index.array,
  initialIndex: index.number,
  getUserConfirmation: index.func,
  keyLength: index.number,
  children: index.node
};
...
Prompt.propTypes = {
  when: index.bool,
  message: index.oneOfType([index.func, index.string]).isRequired
};
Prompt.defaultProps = {
  when: true
};
...
Redirect.propTypes = {
  push: index.bool,
  from: index.string,
  to: index.oneOfType([index.string, index.object])
};
...
Redirect.contextTypes = {
  router: index.shape({
    history: index.shape({
      push: index.func.isRequired,
      replace: index.func.isRequired
    }).isRequired,
    staticContext: index.object
  }).isRequired
};
...
index$5.tokensToFunction = tokensToFunction_1;
index$5.tokensToRegExp = tokensToRegExp_1;
...
var compilePath = function compilePath(pattern, options) {
  ...
  var keys = [];
  var re = index$5(pattern, keys, options);
...
Route.propTypes = {
  computedMatch: index.object, // private, from <Switch>
  path: index.string,
  exact: index.bool,
  strict: index.bool,
  component: index.func,
  render: index.func,
  children: index.oneOfType([index.func, index.node]),
  location: index.object
};
Route.contextTypes = {
  router: index.shape({
    history: index.object.isRequired,
    route: index.object.isRequired,
    staticContext: index.object
  })
};
...
var StaticRouter = function (_React$Component) {
  ...
  StaticRouter.prototype.render = function render() {
    ...
    return React.createElement(Router, _extends$2({}, props, { history: history }));
  };
...
StaticRouter.propTypes = {
  basename: index.string,
  context: index.object.isRequired,
  location: index.oneOfType([index.string, index.object])
};
...
var DelayRoute = function (_React$Component) {
  inherits(DelayRoute, _React$Component);

  function DelayRoute(props, context) {
    classCallCheck(this, DelayRoute);
  ...
  DelayRoute.prototype.render = function render() {
    ...
    if (transitioning || delay) return [React.createElement(Route, _extends$4({ key: 'transitioningTo' }, this.props, { location: { pathname: validDelayPath || rawDelayPath } })), React.createElement(Route, _extends$4({ key: 'main' }, this.props))];

    return React.createElement(Route, _extends$4({ key: 'main' }, this.props));
  };
...
DelayRoute.contextTypes = {
  router: index.shape({
    history: index.object.isRequired, // Needed?
    route: index.object.isRequired, // Needed?
    staticContext: index.object // Needed?
  })
};

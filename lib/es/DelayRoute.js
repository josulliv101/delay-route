...
var DelayRoute = function (_React$Component) {
  ...
  DelayRoute.prototype.render = function render() {
    ...
    if (transitioning || delay) return [React.createElement(Route, _extends({ hidden: true, key: 'transitioningTo' }, this.props, { location: { pathname: validDelayPath || rawDelayPath } })), React.createElement(Route, _extends({ key: 'main' }, this.props))];

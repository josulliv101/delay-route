...
var DelayRoute = function (_React$Component) {
  ...
  DelayRoute.prototype.render = function render() {
    ...
    if (transitioning || delay) return [React.createElement(Route, _extends$4({}, this.props, { location: { pathname: validDelayPath || rawDelayPath } })), React.createElement(Route, _extends$4({ key: 'main' }, this.props))];
